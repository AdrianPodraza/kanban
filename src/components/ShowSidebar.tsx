...
const ShowSidebar: React.FC<ShowSidebarProps> = ({
  ...
  return (
    <>
      ...
      <button
        className={`${isSidebar ? "-translate-x-full " : " translate-x-[260px] "} absolute z-10 flex h-12 w-14 -translate-y-16 items-center justify-center rounded-r-full bg-violet-dark transition-all duration-300`}
        onClick={() => setIsSidebar((isSidebar) => !isSidebar)}
      >
